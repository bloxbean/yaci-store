...
public class PlutusOps {
    ...
    private static void initOps() {
        ...
        try {
            Map<String, Long> map1 = objectMapper.readValue(PLUTUS_V1_COSTS, new TypeReference<LinkedHashMap<String, Long>>() {
            });
            V1_OPS = map1.keySet().stream().toList();

            Map<String, Long> map2 = objectMapper.readValue(PLUTUS_V2_COSTS, new TypeReference<LinkedHashMap<String, Long>>() {
            });
            V2_OPS = map2.keySet().stream().toList();
