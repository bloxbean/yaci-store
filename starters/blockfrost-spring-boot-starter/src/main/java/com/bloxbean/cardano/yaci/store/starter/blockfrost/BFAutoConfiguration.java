...
@Import({BFEpochConfiguration.class, BFAddressConfiguration.class, BFAssetConfiguration.class, BFAccountConfiguration.class, BFScriptsConfiguration.class, BFTransactionConfiguration.class, BFBlockConfiguration.class})
@Slf4j
