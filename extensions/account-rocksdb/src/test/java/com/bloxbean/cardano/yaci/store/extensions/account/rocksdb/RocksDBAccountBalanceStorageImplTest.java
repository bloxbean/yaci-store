...
class RocksDBAccountBalanceStorageImplTest extends RocksDBBaseTest {
    ...
    void getAddressBalance() {
        ...
        addressBal1.setAmounts(List.of(Amt.builder()
                .unit(LOVELACE)
                .quantity(BigInteger.valueOf(1000000000L))
                .build()));
        ...
        addressBal2.setAmounts(List.of(
                Amt.builder()
                .unit(LOVELACE)
                .quantity(BigInteger.valueOf(2000000000L))
                .build(),
                Amt.builder()
                        .unit("424f268a65632944ddfe17967208178082058cbe9044f53aee28697d4f7261636c6546656564")
                        .quantity(BigInteger.valueOf(1200000000L))
                        .build())
        );

        var addressBal3 = new AddressBalance();
        addressBal3.setAddress("addr_test1vz09v9yfxguvlp0zsnrpa3tdtm7el8xufp3m5lsm7qxzclgmzkket");
        addressBal3.setSlot(150000L);
        addressBal3.setAmounts(List.of(
                Amt.builder()
                        .unit(LOVELACE)
                        .quantity(BigInteger.valueOf(3000000000L))
                        .build(),
                Amt.builder()
                .unit("524f268a65632944ddfe17967208178082058cbe9044f53aee28697d4f7261636c6546656564")
                .quantity(BigInteger.valueOf(1400000000L))
                .build())
        );

        var addressBal4 = new AddressBalance();
        addressBal4.setAddress("addr_test1vz09v9yfxguvlp0zsnrpa3tdtm7el8xufp3m5lsm7qxzclgmzkket");
        addressBal4.setSlot(300000L);
        addressBal4.setAmounts(List.of(
                Amt.builder()
                .unit(LOVELACE)
                .quantity(BigInteger.valueOf(3000000000L))
                .build(),
                Amt.builder()
                        .unit("424f268a65632944ddfe17967208178082058cbe9044f53aee28697d4f7261636c6546656564")
                        .quantity(BigInteger.valueOf(1300000000L))
                        .build())
        );

        var addressBal5 = new AddressBalance();
        addressBal5.setAddress("addr_test1xrk9x99ey79w25d3eyqd7zy0qmecl3h4ngqvy5w2yp06nxyhzcvnyv2r9xr86rm4f7dragz4ckudkrs06nylfrwllzcs63c0dy");
        addressBal5.setSlot(250000L);
        addressBal5.setAmounts(List.of(
                Amt.builder()
                .unit(LOVELACE)
                .quantity(BigInteger.valueOf(1500000000L))
                .build()));

        storage.saveAddressBalances(List.of(addressBal1, addressBal2, addressBal3, addressBal4, addressBal5));

        var addressBalance = storage.getAddressBalance("addr_test1vz09v9yfxguvlp0zsnrpa3tdtm7el8xufp3m5lsm7qxzclgmzkket");
        var addressBalance2 = storage.getAddressBalance("addr_test1xrk9x99ey79w25d3eyqd7zy0qmecl3h4ngqvy5w2yp06nxyhzcvnyv2r9xr86rm4f7dragz4ckudkrs06nylfrwllzcs63c0dy");
        var addressBalance3 = storage.getAddressBalance("addr_test1vz09v9yfxguvlp0zsnrpa3tdtm7el8xufp3m5lsm7qxzclgmzkket", 160000L);

        assertThat(addressBalance.get()).isEqualTo(addressBal4);
        assertThat(addressBalance2.get()).isEqualTo(addressBal5);
        assertThat(addressBalance3.get()).isEqualTo(addressBal3);
    }

    @Test
    void getAddressBalanceBySlot() {
        var storage = new RocksDBAccountBalanceStorageImpl(rocksDBConfig);
        ...
        var addressBalance = storage.getAddressBalance("addr_test1vz09v9yfxguvlp0zsnrpa3tdtm7el8xufp3m5lsm7qxzclgmzkket", 160000L);
        var addressBalance2 = storage.getAddressBalance("addr_test1xrk9x99ey79w25d3eyqd7zy0qmecl3h4ngqvy5w2yp06nxyhzcvnyv2r9xr86rm4f7dragz4ckudkrs06nylfrwllzcs63c0dy",260000L);
        var addressBalance3 = storage.getAddressBalance("addr_test1vz09v9yfxguvlp0zsnrpa3tdtm7el8xufp3m5lsm7qxzclgmzkket", 90000L);
        var addressBalance4 = storage.getAddressBalance("addr_test1xrk9x99ey79w25d3eyqd7zy0qmecl3h4ngqvy5w2yp06nxyhzcvnyv2r9xr86rm4f7dragz4ckudkrs06nylfrwllzcs63c0dy", 160000L);

        assertThat(addressBalance.get()).isEqualTo(addressBal3);
        assertThat(addressBalance2.get()).isEqualTo(addressBal5);
        assertThat(addressBalance3).isEmpty();
        assertThat(addressBalance4).isEmpty();
    ...
    void deleteAddressBalance() {
        ...
        var address1LovelaceBal = storage.getAddressBalance("addr_test1vz09v9yfxguvlp0zsnrpa3tdtm7el8xufp3m5lsm7qxzclgmzkket");
        var address2TokenBal = storage.getAddressBalance("addr_test1xrk9x99ey79w25d3eyqd7zy0qmecl3h4ngqvy5w2yp06nxyhzcvnyv2r9xr86rm4f7dragz4ckudkrs06nylfrwllzcs63c0dy");

        assertThat(address1LovelaceBal.get()).isEqualTo(addressBal2);
        assertThat(address2TokenBal).isEmpty();
    }
