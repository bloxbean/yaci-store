package com.bloxbean.cardano.yaci.store.extensions.redis.blocks;
...
@EnableRedisDocumentRepositories(basePackages = "com.bloxbean.cardano.yaci.store.extensions.redis.blocks.*")
