...
1. **Download the latest release**
   ...
   For example: `yaci-store-docker-2.0.3.zip`
...
3. Reset the database: `sudo rm -rf db-data`
...
- **[Plugin Framework Documentation](/docs/v2/plugins/write-first-plugin)** - Dive deeper into plugin development
- **[Plugin API Reference](/docs/v2/plugins/plugin-api-guide)** - Available context variables and functions
- **[Database Access](/plugins/variables/database-access)** - Advanced database queries in plugins
- **[HTTP Client](/docs/v2/plugins/variables-reference-guide/http-client)** - Make HTTP requests from plugins
