...
<Callout type="info">
The Blockfrost-compatible API Support is available since **3.0.0-beta3** (3.x only; not included in 2.0.x releases), and sub-modules now auto-enable with the parent flag.
</Callout>
