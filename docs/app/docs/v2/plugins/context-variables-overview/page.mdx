...
Context variables are pre-defined objects that are automatically injected into plugin scripts. Java plugins access the same services through the typed `PluginContext`. They provide instant access to:
- Database operations
