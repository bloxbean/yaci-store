...
<Callout type="info">
The Blockfrost-compatible endpoints are available since **3.0.0-beta3**.
</Callout>
...
Submission is delegated to the `submit` component. See [Configuration → Transaction submit](/docs/v3/blockfrost/configuration#transaction-submit).
