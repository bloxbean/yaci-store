...
For details on how to install yaci store out-of-the-box applications, please refer to the [Installation](/docs/v3/getting-started/installation/docker) section.
...
check installation section for more details: [Installation](/docs/v3/getting-started/installation/docker#apply-indexes)
