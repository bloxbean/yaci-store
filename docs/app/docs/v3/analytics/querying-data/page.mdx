...
> **Tip:** If you used a relative `export-path`, you must run the DuckDB CLI from the same working directory where yaci-store was started. See [Known Caveats](/docs/v3/analytics/configuration#workspace-sensitive-catalog-path-ducklake) for details.
