...
- **[Plugin Framework Documentation](/docs/v3/plugins/write-first-plugin)** - Dive deeper into plugin development
- **[Plugin API Reference](/docs/v3/plugins/plugin-api-guide)** - Available context variables and functions
- **[Database Access](/plugins/variables/database-access)** - Advanced database queries in plugins
- **[HTTP Client](/docs/v3/plugins/variables-reference-guide/http-client)** - Make HTTP requests from plugins
