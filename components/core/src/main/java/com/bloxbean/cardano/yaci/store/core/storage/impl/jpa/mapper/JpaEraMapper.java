package com.bloxbean.cardano.yaci.store.core.storage.impl.jpa.mapper;
...
public abstract class JpaEraMapper {

    @Mapping(source = "era", target = "era", qualifiedByName = "intToEra")
    public abstract CardanoEra toEra(JpaEraEntity jpaEraEntity);

    @Mapping(source = "era", target = "era", qualifiedByName = "eraToInt")
    public abstract JpaEraEntity toEraEntity(CardanoEra eraEntity);
