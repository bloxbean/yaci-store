...
public class AccountBalanceStorageImpl implements AccountBalanceStorage {
    ...
    public void postConstruct() {
        this.dsl.settings().setBatchSize(1000);
    }
    ...
    public void saveAddressBalances(@NonNull List<AddressBalance> addressBalances) {
        ...
        if (parallelWrite) {
            ...
            ListUtil.partitionAndApplyInParallel(entities, batchSize, this::saveAddrBalanceBatch);
        } else {
    ...
    public void saveStakeAddressBalances(List<StakeAddressBalance> stakeBalances) {
        ...
        if (parallelWrite) {
            ListUtil.partitionAndApplyInParallel(entities, batchSize, this::saveStakeBalanceBatch);
        } else {
